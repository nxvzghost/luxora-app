...
BEGIN
  FOREACH t IN ARRAY ARRAY[
    ...
    -- contact/contact_patient_association (ADR-0055/AD-018): mesmo
    -- raciocínio — resolução de Contact sempre acontece depois do Tenant
    -- já identificado via phoneNumberId, nunca precisa de bypass.
